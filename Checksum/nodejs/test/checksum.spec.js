var Checksum = require('../src/checksum'),
  expect = require('chai').expect;

describe('Checksum', function() {
  describe('#solution', function() {

    it('should return the correct checksum for a small spreadsheet', function() {
      var spreadsheet = [
        [5, 1, 9, 5],
        [7, 5, 3],
        [2, 4, 6, 8]
      ...
      var sut = new Checksum();
      var result = sut.solution(spreadsheet);

      expect(result).to.equal(18);
    });

    it('should return the correct checksum for a large spreadsheet', function() {
      var spreadsheet = [
